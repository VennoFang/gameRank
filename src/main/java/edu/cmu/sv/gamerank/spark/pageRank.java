...
//    }
    ...
    SparkConf sparkConf = new SparkConf().setAppName("JavaPageRank").setMaster("spark://VennodeMacBook-Pro.local:7077");
    ...
    //     URL         neighbor URL
    //     ...
    JavaRDD<String> lines = ctx.textFile("/Users/Venno/github/gamerank/test", 1);
